...
class DecisionCode(str, Enum):  # noqa: UP042
    ...
    TACTICAL_ACTION_REJECTED = "TACTICAL_ACTION_REJECTED"
    REGISTRY_VERIFICATION_PENDING = "REGISTRY_VERIFICATION_PENDING"
    PEER_CONFLICT_ESCALATION = "PEER_CONFLICT_ESCALATION"
    ATOMIC_CLUSTER_DISPATCH = "ATOMIC_CLUSTER_DISPATCH"
