"""
code_map.py — Reusable AST & file helpers for the SAST code locator.
...
try:
    ...
    log.warning("tree-sitter unavailable — AST localization will be skipped: %s", _ts_err)


# Mapping of file extension → Language object
_EXT_TO_LANG = {}
...
def load_source_bytes(path: Path) -> Optional[bytes]:
    ...
    We do **not** decode here — tree-sitter works natively on bytes, and
...
_TYPE_ENUM_MAP: dict = {}
if _TREE_SITTER_AVAILABLE:
    from src.contracts.schemas import ASTNodeType
